...
/// Unique identifier for the message.
 MessageID get id;/// ID of the user who sent the message.
 UserID get authorId;/// ID of the message this one is replying to.
...
@EpochDateTimeConverter() DateTime? get updatedAt;/// Map of reaction keys to lists of user IDs who reacted.
 Map<String, List<UserID>>? get reactions;/// Indicates if the message is pinned.
...
@override @useResult
$Res call({
 MessageID id, UserID authorId, String? replyToMessageId,@EpochDateTimeConverter() DateTime? createdAt,@EpochDateTimeConverter() DateTime? deletedAt,@EpochDateTimeConverter() DateTime? failedAt,@EpochDateTimeConverter() DateTime? sentAt,@EpochDateTimeConverter() DateTime? deliveredAt,@EpochDateTimeConverter() DateTime? seenAt,@EpochDateTimeConverter() DateTime? updatedAt, Map<String, List<UserID>>? reactions, bool? pinned, Map<String, dynamic>? metadata, MessageStatus? status, String streamId
});
